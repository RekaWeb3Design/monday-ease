import { getAllTasks } from "@/data/demoData";
          ...
          return (
            <div key={task.name} className="flex">
              ...
              <div className="w-24 text-right pr-4 pt-2.5 shrink-0">
                {isNewDate && (
                  ...
                  >
                    {isToday
                      ? "📍 MA"
                      : format(new Date(taskDate), "MMM dd.", { locale: hu })}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col items-center shrink-0">
                <div
                  className={`w-3 h-3 rounded-full border-2 mt-3 ${
                    isDone
              ...
              <div className="flex-1 pl-4 pb-2">
                <div
                  className={`rounded-lg py-2.5 px-4 mb-1 flex items-center justify-between gap-3 flex-wrap ${
                    isOverdue
                      ? "bg-red-50"
                      : isDone
                      ? "bg-green-50"
